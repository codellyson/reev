"use strict";var Reev=(()=>{var p=(d,e,t)=>new Promise((r,i)=>{var s=o=>{try{a(t.next(o))}catch(l){i(l)}},n=o=>{try{a(t.throw(o))}catch(l){i(l)}},a=o=>o.done?r(o.value):Promise.resolve(o.value).then(s,n);a((t=t.apply(d,e)).next())});var x=`
  --uxs-bg: #161a24;
  --uxs-bg-input: #11141b;
  --uxs-border: #3a4158;
  --uxs-text: #e2e6f0;
