"use strict";var Reev=(()=>{var p=(l,e,r)=>new Promise((t,s)=>{var i=a=>{try{o(r.next(a))}catch(c){s(c)}},n=a=>{try{o(r.throw(a))}catch(c){s(c)}},o=a=>a.done?t(a.value):Promise.resolve(a.value).then(i,n);o((r=r.apply(l,e)).next())});var x=`
  --uxs-bg: #161a24;
  --uxs-bg-input: #11141b;
  --uxs-border: #3a4158;
  --uxs-text: #e2e6f0;
